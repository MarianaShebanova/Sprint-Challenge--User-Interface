...
Semantic HTML is the use of HTML markup to reinforce meaning, of the information in webpages.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

display: block means that the element is displayed as a block. A block has some whitespace above and below it and tolerates no HTML elements next to it.
...
Very good for branching and merging.
